			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="esewa.com.np" method="post">
							<input type="hidden" name="cmd" value="_cart">
							<input type="hidden" name="business" value="manjit@gmail.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
									...
									<input style="float:right;margin-right:60px;" type="image" name="submit"
										src="https://media.istockphoto.com/id/179568729/vector/under-construction-barrier.jpg?s=612x612&w=0&k=20&c=pSsYcbo1Xf4_Yd0dFNTIrrEwKDb8M2WGZWa1j3YhJyc=" alt=""
										alt="">
								</form>';
				}
			}
